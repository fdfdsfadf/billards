  ...
  create: function () {
    ...
    this.resizeGame = function (scale, bounds) {
      ...
      if (window.famobi.getOrientation() == "portrait") {
        ...
        menuInfo.settingsButton.scale = new Point(0.5, 0.5);
        ...
        menuInfo.pVpButton.y = game.height * 0.07;

        menuInfo.pVAIButton.x = 0;
        menuInfo.pVAIButton.y = -game.height * 0.07;
        ...
        menuInfo.pVpButton.x = 0;
        menuInfo.pVpButton.y = game.height * 0.16;

        menuInfo.pVAIButton.x = 0;
        menuInfo.pVAIButton.y = -game.height * 0.05;
        ...
        menuInfo.famobiMoreGames.y =
          menuInfo.copyright.y + menuInfo.copyright.height * 0.5;
      ...
      var margin =
        String(
          Math.abs(
            clientHeight - document.getElementById("mygame").clientHeight
          ) / 2
        ) + "px";
    ...
    menuInfo.playButton = new Phaser.Button(
      game,
      0,
      0,
      "playButton",
    ...
    menuInfo.pVpButton = new Phaser.Button(
      game,
      0,
      0,
      "pVpButton",
    ...
    if (window.famobi.hasFeature("multiplayer_local"))
    ...
    menuInfo.pVAIButton = new Phaser.Button(
      game,
      0,
      0,
      "pVAIButton",
    ...
    menuInfo.statsButton = new Phaser.Button(
      game,
      0,
      0,
      "statsButton",
    ...
    menuInfo.helpButton = new Phaser.Button(
      game,
      0,
      0,
      "helpButton",
    ...
    menuInfo.settingsButton = new Phaser.Button(
      game,
      0,
      0,
      "settingsButton",
    ...
    menuInfo.statsWindow = new Phaser.Group(
      game,
      menuInfo.menuCanvas,
      "statsWindow",
      true
    ...
    menuInfo.statsWindow.anchor = new Point(0.5, 0.5);
    menuInfo.statsWindow.visible = false;

    let hsPosition = -50;
    let hsGap = 300;

    var hsIcon = new Phaser.Sprite(
      game,
      -hsGap / 2,
      hsPosition - 120,
      "highScore"
    );
    hsIcon.anchor = new Point(0.5, 0.5);
    hsIcon.scale = new Point(0.9, 0.9);
    menuInfo.statsWindow.addChild(hsIcon);

    var clockIcon = new Phaser.Sprite(
      game,
      -hsGap / 2,
      hsPosition,
      "clockIcon"
    );
    clockIcon.anchor = new Point(0.5, 0.5);
    clockIcon.scale = new Point(0.9, 0.9);
    menuInfo.statsWindow.addChild(clockIcon);

    var gameControllerIcon = new Phaser.Sprite(
      game,
      -hsGap / 2,
      hsPosition + 120,
      "gameController"
    );
    gameControllerIcon.anchor = new Point(0.5, 0.5);
    menuInfo.statsWindow.addChild(gameControllerIcon);

    menuInfo.highscoreText = new Phaser.BitmapText(
      game,
      hsGap / 2,
      hsPosition - 120,
      "font7",
    ...
    menuInfo.highscoreText.anchor = new Point(0.5, 0.5);
    ...
    menuInfo.bestTimeText = new Phaser.BitmapText(
      game,
      hsGap / 2,
      hsPosition,
      "font7",
    ...
    menuInfo.bestTimeText.anchor = new Point(0.5, 0.5);
    menuInfo.statsWindow.addChild(menuInfo.bestTimeText);

    menuInfo.numGamesText = new Phaser.BitmapText(
      game,
      hsGap / 2,
      hsPosition + 120,
      "font7",
    ...
    menuInfo.numGamesText.anchor = new Point(0.5, 0.5);
    menuInfo.statsWindow.addChild(menuInfo.numGamesText);

    menuInfo.quitStatsButton = new Phaser.Button(
      game,
      0,
      288,
      "quitButton",
    ...
    menuInfo.quitStatsButton.anchor = new Point(0.5, 0.5);
    menuInfo.quitStatsButton.scale = new Point(0.6, 0.6);
    ...
    menuInfo.settingsWindow.anchor = new Point(0.5, 0.5);
    menuInfo.settingsWindow.visible = false;
    menuInfo.quitSettingsButton = new Phaser.Button(
      game,
      0,
      238,
      "quitButton",
    ...
    menuInfo.quitSettingsButton.anchor = new Point(0.5, 0.5);
    menuInfo.quitSettingsButton.scale = new Point(0.6, 0.6);
    menuInfo.settingsWindow.addChild(menuInfo.quitSettingsButton);

    let gap = 400; //295;

    //guide switch
    menuInfo.guideSwitch = new Phaser.Button(
      game,
      (externalMute ? -gap / 2 : -295) + 15,
      12,
      "switch",
      onGuideClick,
      this,
    ...
    menuInfo.guideSwitch.anchor = new Point(0.5, 0.5);
    ...
    //sound switch
    menuInfo.soundSwitch = new Phaser.Button(
      game,
      295 + 15,
      12,
      "switch",
    ...
    menuInfo.soundSwitch.anchor = new Point(0.5, 0.5);
    ...
    menuInfo.minusButton = new Phaser.Button(
      game,
      position - 75,
      12,
      "minusButton",
    ...
    menuInfo.minusButton.anchor = new Point(0.5, 0.5);
    menuInfo.minusButton.scale = new Point(0.6, 0.6);
    menuInfo.settingsWindow.addChild(menuInfo.minusButton);

    menuInfo.ratingText = new Phaser.BitmapText(
      game,
      position - 5,
      20,
      "font7",
    ...
    menuInfo.ratingText.anchor = new Point(0.5, 0.5);
    menuInfo.settingsWindow.addChild(menuInfo.ratingText);

    menuInfo.plusButton = new Phaser.Button(
      game,
      position + 75,
      12,
      "plusButton",
    ...
    menuInfo.plusButton.anchor = new Point(0.5, 0.5);
    menuInfo.plusButton.scale = new Point(0.6, 0.6);
    ...
    menuInfo.famobiMoreGames = new Phaser.Button(
      game,
      0,
      0,
      "more_games",
      famobiMoreGamesClick,
      this,
      0,
      0,
      0,
    ...
    var tween = game.add.tween(menuInfo.menuCanvas).to(
      {
        alpha: 1,
      },
      1000,
    ...
    function onPlayClick() {
      ...
      game.add.tween(menuInfo.pVpButton).to(
        {
          alpha: 1,
        },
        500,
      ...
      game.add.tween(menuInfo.pVAIButton).to(
        {
          alpha: 1,
        },
        500,
    ...
    function initGame() {
      window.famobi_analytics
        ...
        .then(
          function () {
            if (
              window.famobi.localStorage.getItem("showTutorial") == "true" ||
              window.famobi.localStorage.getItem("showTutorial") == null
            ) {
    ...
    function onStatsClick() {
      ...
      game.add.tween(menuInfo.statsWindow).to(
        {
          alpha: 1,
        },
        500,
    ...
    function onSettingsClick() {
      ...
      game.add.tween(menuInfo.settingsWindow).to(
        {
          alpha: 1,
        },
        500,
...
function showMenuItems() {
  ...
  game.add.tween(menuInfo.rack).to(
    {
      alpha: 1,
    },
    500,
  ...
  game.add.tween(menuInfo.playButton).to(
    {
      alpha: 1,
    },
    500,
  ...
  game.add.tween(menuInfo.statsButton).to(
    {
      alpha: 1,
    },
    500,
  ...
  game.add.tween(menuInfo.helpButton).to(
    {
      alpha: 1,
    },
    500,
  ...
  game.add.tween(menuInfo.settingsButton).to(
    {
      alpha: 1,
    },
    500,
