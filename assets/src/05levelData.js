var setBallPositions = function (gameInfo) {
  ...
  switch (level) {
    case 1:
      ...
      ballPositionArray[2] = new Point(
        px + k * gameInfo.ballRadius,
        gameInfo.ballRadius * j
      );
      ballPositionArray[3] = new Point(
        px + k * gameInfo.ballRadius,
        -gameInfo.ballRadius * j
      );
    ...
    case 3:
      ...
      ballPositionArray[4] = new Point(
        px + 2 * k * gameInfo.ballRadius,
        2 * gameInfo.ballRadius * j
      );
      ballPositionArray[5] = new Point(
        px + 2 * k * gameInfo.ballRadius,
        -2 * gameInfo.ballRadius * j
      );
    ...
    case 4:
      ...
      ballPositionArray[7] = new Point(
        px + 3 * k * gameInfo.ballRadius,
        -gameInfo.ballRadius * j
      );
      ballPositionArray[8] = new Point(
        px + 3 * k * gameInfo.ballRadius,
        gameInfo.ballRadius * j
      );
    ...
    case 15:
      ...
      ballPositionArray[15] = new Point(
        px + k * gameInfo.ballRadius,
        -gameInfo.ballRadius * j
      );
      ...
      ballPositionArray[10] = new Point(
        px + 2 * k * gameInfo.ballRadius,
        -2 * gameInfo.ballRadius * j
      );
      ballPositionArray[7] = new Point(
        px + 3 * k * gameInfo.ballRadius,
        1 * gameInfo.ballRadius * j
      );
      ballPositionArray[4] = new Point(
        px + 3 * k * gameInfo.ballRadius,
        3 * gameInfo.ballRadius * j
      );
      ballPositionArray[9] = new Point(
        px + 3 * k * gameInfo.ballRadius,
        -1 * gameInfo.ballRadius * j
      );
      ballPositionArray[6] = new Point(
      ...
      ballPositionArray[12] = new Point(
        px + 4 * k * gameInfo.ballRadius,
        2 * gameInfo.ballRadius * j
      );
      ballPositionArray[13] = new Point(
        px + 4 * k * gameInfo.ballRadius,
        -2 * gameInfo.ballRadius * j
      );
      ballPositionArray[14] = new Point(
        px + 4 * k * gameInfo.ballRadius,
        4 * gameInfo.ballRadius * j
      );
      ballPositionArray[3] = new Point(
        px + 4 * k * gameInfo.ballRadius,
        -4 * gameInfo.ballRadius * j
