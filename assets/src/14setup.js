...
playState.create = function () {
  ...
  function gameToMenu() {
    ...
    var tween1 = game.add.tween(gameInfo.guiCanvas).to(
      {
        alpha: 0,
      },
      1000,
    ...
    var tween3 = game.add.tween(gameInfo.guiBaseCanvas).to(
      {
        alpha: 0,
      },
      1000,
    ...
    var tween2 = game.add.tween(gameInfo.gameCanvas).to(
      {
        alpha: 0,
      },
      1000,
  ...
  function initCanvases() {
    ...
    var tween = game.add.tween(gameInfo.cueBaseCanvas).from(
      {
        alpha: 0,
      },
      1000,
    ...
    var tween = game.add.tween(gameInfo.guiCanvas).from(
      {
        alpha: 0,
      },
      1000,
    ...
    var tween = game.add.tween(gameInfo.guiBaseCanvas).from(
      {
        alpha: 0,
      },
      1000,
    ...
    var tween = game.add.tween(gameInfo.gameCanvas).from(
      {
        alpha: 0,
      },
      1000,
