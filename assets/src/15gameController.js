  ...
  function runTutorial() {
    ...
    if (projectInfo.tutorial == true) {
      ...
      switch (gameInfo.tutStage) {
        ...
        case 13:
          var tween6 = game.add.tween(gameInfo.guiCanvas).to(
            {
              alpha: 0,
            },
            1000,
          ...
          var tween7 = game.add.tween(gameInfo.guiBaseCanvas).to(
            {
              alpha: 0,
            },
            1000,
          ...
          var tween8 = game.add.tween(gameInfo.gameCanvas).to(
            {
              alpha: 0,
            },
            1000,
        ...
        case 100:
          if (gameInfo.cancelTutorial == false) {
            ...
            //tween cue too
            var tween10 = game.add.tween(gameInfo.cue).to(
              {
                x: -120,
              },
              1500,
...
*/
  ...
  function placeCueBall() {
    if (
      ...
      if (gameInfo.moverMouseDown == true) {
        gameInfo.placeFirstTimeMouseUp = true;
        game.add.tween(cueBall.mover).to(
          {
            alpha: 1,
          },
          500,
  ...
  function showFoulMessage() {
    if (
      ...
      game.add.tween(gameInfo.foulWindow).to(
        {
          alpha: 1,
        },
        1000,
  ...
  function strikeBallAI(vx, vy, s, e) {
    if (gameInfo.turn == "p2") {
      ...
      if (gameInfo.trial == false) {
        ...
        game.add.tween(gameInfo.cue).to(
          {
        ...
        game.add.tween(gameInfo.cueShadow).to(
          {
            x: gameInfo.power / 600,
          },
          500,
