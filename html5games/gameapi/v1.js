    ...
    var famobi = {
            ...
            if (!this.config) {
              readTextFile(
                ...
                function (text) {
                  ...
                  if (window.gameJS && window.gameJS.length) {
                    if (
                      typeof window.gameJS[window.gameJS.length - 1] == "string"
                    ) {
                  ...
                  var getGameTitle = function () {
                    ...
                    return toTitleCase(window.gameID.replaceAll("-", " "));
                  };
                  ...
                  resolve(window.gameID === "running-jack" ? false : true);
                }.bind(this)
              );
            }
      ...
      sessionStorage: {
        setItem: function (key, value) {
          try {
            window.sessionStorage.setItem(window.gameID + ":" + key, value);
          } catch (e) {
            window.famobi.config.logging &&
        ...
        getItem: function (key) {
          try {
            return window.sessionStorage.getItem(window.gameID + ":" + key);
          } catch (e) {
            window.famobi.config.logging &&
              console.log("[SessionStorage] Skipped because of issues");
          }
        ...
        removeItem: function (key) {
          try {
            window.sessionStorage.removeItem(window.gameID + ":" + key);
          } catch (e) {
            window.famobi.config.logging &&
              console.log("[SessionStorage] Skipped because of issues");
          }
        ...
        clear: function () {
          try {
            for (var key in window.sessionStorage) {
              if (key.startsWith(window.gameID + ":")) {
      ...
      localStorage: {
        setItem: function (key, value) {
          try {
            window.localStorage.setItem(window.gameID + ":" + key, value);
          } catch (e) {
            window.famobi.config.logging &&
        ...
        getItem: function (key) {
          try {
            return window.localStorage.getItem(window.gameID + ":" + key);
          } catch (e) {
            window.famobi.config.logging &&
              console.log("[LocalStorage] Skipped because of issues");
          }
        ...
        removeItem: function (key) {
          try {
            window.localStorage.removeItem(window.gameID + ":" + key);
          } catch (e) {
            window.famobi.config.logging &&
              console.log("[LocalStorage] Skipped because of issues");
          }
      ...
      Promise.all(
        ...
        setTimeout(function () {
          (function next() {
            ...
            var currentScript = window.gameJS.shift();
